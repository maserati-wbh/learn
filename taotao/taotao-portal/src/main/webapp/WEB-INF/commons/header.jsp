...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld"><a href="http://home.jd.com/" clstag="homepage|keycount|home2012|04a">我的淘淘</a><b></b></dt>
				<dd>
		...
		<div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
			<dl>
				<dt class="ld"><span class="shopping"><span id="shopping-amount"></span></span><a href="http://www.taotao.com/cart/showCart.html" id="settleup-url">去购物车结算</a> <b></b> </dt>
			</dl>
		</div>
		<!--settleup end-->
	</div>
	...
	<div class="w">
		<div id="nav-2013">
			<div id="categorys-2013" class="categorys-2014">
				<div class="mt ld">
					<h2><a href="http://www.taotao.com" clstag="homepage|keycount|home2013|06a">全部商品分类<b></b></a></h2>
				</div>
				<div id="_JD_ALLSORT" class="mc">
					...
					<div class="extra">
						<a clstag="homepage|keycount|home2013|0614a"
							 href="http://www.taotao.com">全部商品分类</a>
					</div>
				</div>
			</div>
