...
<body id="mainframe">
	...
	<div class="w w1 header clearfix">
	    ...
	    <img src="/images/taotao-logo.gif" alt="淘淘商城"/></a></div>
	</div>
	<!-- /header -->
   ...
   <!--满赠套装商品-->
	 ...
	 <c:forEach items="${carts }" var="cart">     						
        <div class="goods-item goods-item-extra">
				...
				<div class="p-img">
					<a target="_blank" href="http://item.taotao.com/${cart.itemId}.html"><img src="${cart.itemImage}"/></a>
				</div>
				<div class="goods-msg">					
					<div class="p-name">
					     <a href="http://item.taotao.com/${cart.itemId}.html" target="_blank">
					           ${cart.itemTitle }				     
					     </a>
					</div>
          <div class="p-price">
